/*
    570mainDiffuse.c
    Implements diffuse reflection with a directional light.
...
On macOS, make sure that NUMDEVICEEXT below is 2, and then compile with 
    clang 570mainDiffuse.c -lglfw -lvulkan
You might also need to compile the shaders with 
    glslc 570shader.vert -o 570vert.spv
    glslc 570shader.frag -o 570frag.spv
Then run the program with 
    ./a.out

On Linux, make sure that NUMDEVICEEXT below is 1, and then compile with 
    clang 570mainDiffuse.c -lglfw -lvulkan -lm
You might also need to compile the shaders with 
    /mnt/c/VulkanSDK/1.3.216.0/Bin/glslc.exe 570shader.vert -o 570vert.spv
    /mnt/c/VulkanSDK/1.3.216.0/Bin/glslc.exe 570shader.frag -o 570frag.spv
...
void setSceneUniforms(uint32_t imageIndex) {
    ...
    /* Sets the color and direction of the light. */
